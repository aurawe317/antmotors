...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    /* ---- public clear of SEED/SAMPLE demo cars (no auth) ----
       Used by the in-app "Clear demo data" button even when the viewer has no
       session token (e.g. opened straight from a shared link). Only ever removes
